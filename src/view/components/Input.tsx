  ...
  ({ placeholder, name, id, error, className, ...props }, ref) => {
    ...
    return (
      <div className="relative">
        ...
        placeholder=" "
        className={cn(
          "bg-white w-full rounded-lg border border-gray-500 px-3 h-[52px] text-gray-800 pt-4 peer placeholder-shown:pt-0 focus:border-teal-900 transition-all outline-none",
